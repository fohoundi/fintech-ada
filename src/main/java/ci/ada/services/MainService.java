...
import ci.ada.builders.CustomerBuilder;
...
import ci.ada.services.bridge.BalanceService;
import ci.ada.services.bridge.VipBalanceService;
    ...
    public void showMenu(UserAccount user){
        ...
        switch (accountType){
            case CUSTOMER -> {
                ...
                if (customer != null) {
                    customer.setTransactionAction(balanceService); //Injection du type de Balance choisi
                    menuUser(customer);
                } else {
